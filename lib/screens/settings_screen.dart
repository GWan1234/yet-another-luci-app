...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Dashboard Section
          _buildSectionHeader(context, 'DASHBOARD', Icons.dashboard_customize_outlined),
          const SizedBox(height: 8),
          _buildCustomizeDashboardTile(context),
          const SizedBox(height: 24),

          // Router Diagnostics & Surface Section
          _buildSectionHeader(context, 'ROUTER DIAGNOSTICS & SURFACE', Icons.radar_outlined),
          const SizedBox(height: 8),
          _buildCapabilitiesTile(context, appState),
          const SizedBox(height: 24),

          // Subscription (if monetization enabled)
          ...
          if (AppConfig.isCommunityFlavor) ...[
            _buildSectionHeader(context, 'APP UPDATES', Icons.system_update_outlined),
            const SizedBox(height: 8),
          ...
          _buildSectionHeader(context, 'BUILD VERIFICATION & PRIVACY', Icons.verified_user_outlined),
          const SizedBox(height: 8),
  ...
  Widget _buildActiveRouterBanner(BuildContext context, AppState appState) {
    ...
    final hostname = router.lastKnownHostname?.isNotEmpty == true
        ...
        : router.ipAddress;
    final boardName = appState.dashboardData?['system']?['board_name'] as String? ??
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          LuciStatusIndicators.statusDot(context, appState.hasActiveSession, size: 8),
    ...
    return Container(
      ...
      child: Material(
        ...
        child: ListTile(
          ...
          trailing: Icon(
            isOfficial ? Icons.check_circle_rounded : Icons.warning_amber_rounded,
            size: 22,
            color: isOfficial
                ? LuciStatusColors.connected
