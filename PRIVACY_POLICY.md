...
### b. Third-Party Ad Services (Exists only for Play Store version)
...
- **Advertising**: Displaying relevant banner ads to free-tier Play Store version users via AdMob.
