...
void main() {
  group('DashboardPreferences Customization Tests', () {
    test('Default DashboardPreferences initializes with expected layout defaults', () {
    ...
    test('Serialization to/from JSON round-trip preserves custom preferences', () {
      ...
      expect(restored.enabledQuickActions, containsAll(['reboot', 'flush_dns']));
    ...
    test('resolveSpecificInterface correctly resolves logical lan interface to Linux device br-lan', () {
      final prefs = DashboardPreferences(
